...
668 distinct addresses · 130 resolve to a name · 538 do not.

| Address | Region | Identity | Cited by |
|---|---|---|---|
| `0x80000000` | kernel | unknown | `HANDOFF.md` |
| `0x800000A0` | kernel | unknown | `OVERLAYS.md`, `STATUS.md` |
| `0x800027AC` | kernel | unknown | `OVERLAY_HEADERS.md` |
| `0x80003554` | kernel | unknown | `OVERLAY_HEADERS.md` |
| `0x80010000` | pre-text | unknown | `FURIGANA.md`, `HANDOFF.md`, `IDEAS.md`, `LOCALIZATION.md`, `LOCALIZATION_APPLY.md`, `NAME_MAP.md`, `OVERLAYS.md`, `README.md`, `STATUS.md`, `TEXT_ENGINE.md`, `TEXT_TABLES.md`, `regional-builds.md` |
| `0x80010004` | pre-text | unknown | `LOCALIZATION.md`, `STATUS.md`, `TEXT_ENGINE.md` |
| `0x80010008` | pre-text | unknown | `IDEAS.md` |
| `0x800102A7` | pre-text | unknown | `IDEAS.md` |
| `0x80010371` | pre-text | unknown | `LOCALIZATION_APPLY.md`, `STATUS.md`, `TEXT_ENGINE.md` |
| `0x80013FFF` | pre-text | unknown | `LOCALIZATION.md`, `TEXT_ENGINE.md` |
| `0x80014000` | pre-text | unknown | `FURIGANA.md`, `HANDOFF.md`, `IDEAS.md`, `LOCALIZATION_APPLY.md`, `STATUS.md`, `TEXT_ENGINE.md`, `TEXT_TABLES.md`, `regional-builds.md` |
| `0x80014004` | pre-text | unknown | `TEXT_ENGINE.md` |
| `0x80014A86` | pre-text | unknown | `STATUS.md`, `TEXT_ENGINE.md` |
| `0x8001525C` | pre-text | unknown | `TEXT_ENGINE.md`, `TEXT_TABLES.md` |
| `0x80017628` | pre-text | unknown | `FURIGANA.md`, `HANDOFF.md`, `STATUS.md`, `TEXT_ENGINE.md` |
...
| `0x80093800` | text | boot EXE load address (disc_probe.json) | `AREA_PCS.md`, `BATTLE_RAM.md`, `BRINGUP.md`, `GHIDRA.md`, `HANDOFF.md`, `INVENTORY.md`, `LOCALIZATION.md`, `OVERLAY_EXTRACTION.md`, `OVERLAY_HEADERS.md`, `OVERLAY_SIZE.md`, `STATUS.md`, `TEXT_ENGINE.md`, `regional-builds.md`, `remote-plan-2026-09-05.md`, `zero-fill-dispatch-audit.md` |
| `0x80093801` | text | unknown | `OVERLAYS.md`, `STATUS.md` |
| `0x80093A74` | text | unknown | `STATUS.md` |
...
| `0x8009FA78` | text | unknown | `BATTLE_RAM.md`, `HANDOFF.md`, `STATUS.md`, `remote-plan-2026-09-05.md` |
| `0x800A0680` | text | unknown | `BATTLE_RAM.md`, `GHIDRA.md` |
| `0x800A783C` | text | unknown | `BATTLE_RAM.md` |
...
| `0x800A9FA4` | text | unknown | `BATTLE_RAM.md` |
| `0x800AAF44` | text | unknown | `OVERLAY_HEADERS.md` |
...
| `0x800B1430` | text | unknown | `BATTLE_RAM.md`, `STATUS.md`, `remote-plan-2026-09-05.md` |
| `0x800B1438` | text | unknown | `BATTLE_RAM.md`, `STATUS.md` |
| `0x800B164C` | text | unknown | `BATTLE_RAM.md`, `STATUS.md` |
| `0x800B165C` | text | unknown | `BATTLE_RAM.md`, `HANDOFF.md`, `STATUS.md` |
| `0x800B19A4` | text | unknown | `OVERLAY_HEADERS.md` |
| `0x800B19A8` | text | unknown | `OVERLAY_HEADERS.md` |
...
| `0x800B3A00` | text | unknown | `OVERLAY_HEADERS.md` |
| `0x800B3A64` | text | unknown | `OVERLAY_HEADERS.md` |
| `0x800B3AC0` | text | unknown | `OVERLAY_HEADERS.md` |
| `0x800B3B08` | text | unknown | `OVERLAY_HEADERS.md` |
| `0x800B4003` | text | unknown | `HANDOFF.md`, `OVERLAY_EXTRACTION.md` |
| `0x800C1800` | text | unknown | `AREA_PCS.md`, `BATTLE_RAM.md`, `HANDOFF.md`, `NAME_MAP.md`, `OVERLAYS.md`, `OVERLAY_EXTRACTION.md`, `OVERLAY_HEADERS.md`, `OVERLAY_SIZE.md`, `STATUS.md` |
| `0x800C1801` | text | unknown | `OVERLAYS.md`, `zero-fill-dispatch-audit.md` |
| `0x800C1CC0` | text | Boss021_HandlerTable (pointer table) in Boss battle script 021 (BIN/BOSS/BOSS021.EMI#16) | `DATA_ISLANDS.md` |
| `0x800C2680` | text | unknown | `BATTLE_RAM.md`, `STATUS.md` |
| `0x800C2B00` | text | unknown | `BATTLE_RAM.md`, `STATUS.md` |
| `0x800D3800` | text | unknown | `OVERLAYS.md`, `regional-builds.md` |
| `0x800DCD40` | text | unnamed function root (seeds/ghidra_funcs.txt) | `zero-fill-dispatch-audit.md` |
| `0x800E3800` | text | unknown | `IDEAS.md`, `OVERLAYS.md` |
| `0x800E4000` | text | unknown | `regional-builds.md` |
| `0x800E407C` | text | unknown | `BATTLE_RAM.md`, `STATUS.md` |
| `0x800E4800` | text | unknown | `OVERLAY_HEADERS.md` |
| `0x800E7000` | text | unknown | `OVERLAY_EXTRACTION.md` |
| `0x800E7CF0` | text | unknown | `STATUS.md` |
| `0x800F5000` | text | unknown | `AREA_PCS.md`, `LOCALIZATION.md`, `OVERLAYS.md`, `OVERLAY_EXTRACTION.md`, `OVERLAY_SIZE.md`, `zero-fill-dispatch-audit.md` |
| `0x800F5001` | text | unknown | `OVERLAYS.md` |
| `0x80104000` | text | unknown | `IDEAS.md`, `OVERLAYS.md` |
| `0x80117000` | text | unknown | `AREA_PCS.md`, `HANDOFF.md`, `OVERLAYS.md`, `OVERLAY_EXTRACTION.md`, `STATUS.md`, `band-overlap-attribution.md` |
| `0x80117001` | text | unknown | `OVERLAYS.md`, `zero-fill-dispatch-audit.md` |
...
| `0x80143BB0` | text | unknown | `TEXT_ENGINE.md`, `WORLD_ITEMS.md` |
| `0x80143F00` | text | unknown | `BATTLE_RAM.md`, `LOCALIZATION_APPLY.md`, `OVERLAY_HEADERS.md`, `SAVE_IMPORT.md`, `STATUS.md` |
| `0x80143F2C` | text | unknown | `STATUS.md` |
| `0x80144000` | text | unknown | `WORLD_ITEMS.md` |
| `0x801448D4` | text | unknown | `BATTLE_RAM.md`, `STATUS.md`, `remote-plan-2026-09-05.md` |
| `0x80144944` | text | unknown | `BATTLE_RAM.md` |
| `0x8014494E` | text | unknown | `BATTLE_RAM.md` |
| `0x80144963` | text | unknown | `INSERT_RUBY.md`, `TEXT_ENGINE.md` |
| `0x80144964` | text | unknown | `BATTLE_RAM.md`, `STATUS.md` |
| `0x8014496C` | text | unknown | `BATTLE_RAM.md`, `STATUS.md`, `remote-plan-2026-09-05.md` |
| `0x80144972` | text | unknown | `BATTLE_RAM.md` |
| `0x80144984` | text | unknown | `BATTLE_RAM.md` |
| `0x80144988` | text | unknown | `BATTLE_RAM.md` |
| `0x80144A10` | text | unknown | `remote-plan-2026-09-05.md` |
| `0x80144AB4` | text | unknown | `remote-plan-2026-09-05.md` |
| `0x80144B40` | text | unknown | `STATUS.md` |
| `0x80144B56` | text | unknown | `BATTLE_RAM.md` |
| `0x80144B58` | text | unknown | `BATTLE_RAM.md`, `STATUS.md`, `remote-plan-2026-09-05.md` |
| `0x80144C10` | text | unknown | `STATUS.md` |
| `0x80144E84` | text | unknown | `BATTLE_RAM.md` |
| `0x80144F24` | text | unknown | `BATTLE_RAM.md`, `WORLD_ITEMS.md` |
| `0x80144F4C` | text | unknown | `BATTLE_RAM.md`, `STATUS.md`, `WORLD_ITEMS.md`, `remote-plan-2026-09-05.md` |
| `0x80144F50` | text | unknown | `WORLD_ITEMS.md` |
| `0x80144F54` | text | unknown | `BATTLE_RAM.md`, `STATUS.md`, `remote-plan-2026-09-05.md` |
| `0x80144F56` | text | unknown | `BATTLE_RAM.md`, `STATUS.md` |
| `0x80144FBC` | text | unknown | `BATTLE_RAM.md`, `HANDOFF.md`, `STATUS.md`, `remote-plan-2026-09-05.md` |
| `0x80144FBE` | text | unknown | `BATTLE_RAM.md` |
| `0x80145000` | text | unknown | `README.md`, `WORLD_ITEMS.md` |
| `0x80145002` | text | unknown | `WORLD_ITEMS.md` |
| `0x80145020` | text | unknown | `BATTLE_RAM.md`, `OVERLAY_HEADERS.md` |
| `0x80145021` | text | unknown | `BATTLE_RAM.md` |
| `0x8014502C` | text | unknown | `BATTLE_RAM.md`, `STATUS.md`, `WORLD_ITEMS.md` |
| `0x80145030` | text | unknown | `WORLD_ITEMS.md` |
| `0x80145040` | text | unknown | `BATTLE_RAM.md`, `remote-plan-2026-09-05.md` |
| `0x80145048` | text | unknown | `BATTLE_RAM.md`, `STATUS.md`, `WORLD_ITEMS.md` |
| `0x801450C8` | text | unknown | `BATTLE_RAM.md` |
| `0x801450CD` | text | unknown | `BATTLE_RAM.md` |
| `0x80145148` | text | unknown | `BATTLE_RAM.md` |
| `0x801451C8` | text | unknown | `BATTLE_RAM.md` |
| `0x80145248` | text | unknown | `BATTLE_RAM.md`, `STATUS.md` |
| `0x8014524C` | text | unknown | `BATTLE_RAM.md` |
| `0x801452C8` | text | unknown | `BATTLE_RAM.md` |
| `0x801452CA` | text | unknown | `BATTLE_RAM.md` |
| `0x801452CD` | text | unknown | `BATTLE_RAM.md` |
| `0x80145348` | text | unknown | `BATTLE_RAM.md` |
| `0x801453C8` | text | unknown | `BATTLE_RAM.md` |
| `0x80145440` | text | unknown | `BATTLE_RAM.md` |
| `0x80145448` | text | unknown | `BATTLE_RAM.md`, `STATUS.md`, `TEXT_TABLES.md`, `WORLD_ITEMS.md` |
| `0x80145468` | text | unknown | `BATTLE_RAM.md` |
| `0x80145470` | text | unknown | `BATTLE_RAM.md`, `remote-plan-2026-09-05.md` |
| `0x80145554` | text | unknown | `BATTLE_RAM.md` |
| `0x80145574` | text | unknown | `BATTLE_RAM.md` |
| `0x80145588` | text | unknown | `BATTLE_RAM.md` |
| `0x80145590` | text | unknown | `BATTLE_RAM.md` |
| `0x80145600` | text | unknown | `BATTLE_RAM.md` |
| `0x80145984` | text | unknown | `BATTLE_RAM.md`, `STATUS.md` |
| `0x80145AB0` | text | unknown | `BATTLE_RAM.md` |
| `0x80145AC0` | text | unknown | `IDEAS.md` |
| `0x80145AC6` | text | unknown | `IDEAS.md`, `TEXT_ENGINE.md` |
| `0x80145AC8` | text | unknown | `TEXT_ENGINE.md` |
| `0x80145AD0` | text | unknown | `BATTLE_RAM.md` |
| `0x80145E8C` | text | unknown | `BATTLE_RAM.md`, `OVERLAY_HEADERS.md`, `STATUS.md`, `remote-plan-2026-09-05.md` |
| `0x80145E8D` | text | unknown | `BATTLE_RAM.md` |
| `0x80145E91` | text | unknown | `BATTLE_RAM.md` |
| `0x80145E94` | text | unknown | `BATTLE_RAM.md` |
| `0x80145E95` | text | unknown | `BATTLE_RAM.md` |
| `0x80145E97` | text | unknown | `BATTLE_RAM.md` |
| `0x80145E98` | text | unknown | `BATTLE_RAM.md` |
| `0x80145EB0` | text | unknown | `BATTLE_RAM.md` |
| `0x80145EB5` | text | unknown | `BATTLE_RAM.md` |
| `0x80145EB7` | text | unknown | `BATTLE_RAM.md` |
| `0x80145EBA` | text | unknown | `BATTLE_RAM.md` |
| `0x80145EC0` | text | unknown | `BATTLE_RAM.md` |
| `0x80145ECA` | text | unknown | `BATTLE_RAM.md` |
| `0x80145ED4` | text | unknown | `BATTLE_RAM.md` |
| `0x80145ED6` | text | unknown | `BATTLE_RAM.md` |
| `0x80145EE8` | text | unknown | `BATTLE_RAM.md` |
| `0x80145EEC` | text | unknown | `BATTLE_RAM.md` |
| `0x80145F00` | text | unknown | `BATTLE_RAM.md`, `STATUS.md` |
| `0x80145F05` | text | unknown | `BATTLE_RAM.md`, `TEXT_ENGINE.md` |
| `0x80145F06` | text | unknown | `BATTLE_RAM.md` |
| `0x80145F08` | text | unknown | `BATTLE_RAM.md` |
| `0x80145F0C` | text | unknown | `BATTLE_RAM.md`, `HANDOFF.md`, `STATUS.md` |
| `0x80145F0E` | text | unknown | `BATTLE_RAM.md` |
| `0x80145F14` | text | unknown | `BATTLE_RAM.md`, `GHIDRA.md`, `STATUS.md` |
| `0x80145F16` | text | unknown | `BATTLE_RAM.md` |
| `0x80145F18` | text | unknown | `BATTLE_RAM.md` |
| `0x80145F1C` | text | unknown | `BATTLE_RAM.md` |
| `0x80145F1E` | text | unknown | `BATTLE_RAM.md` |
| `0x80145F3C` | text | unknown | `BATTLE_RAM.md` |
| `0x80145FA4` | text | unknown | `BATTLE_RAM.md` |
| `0x80145FA5` | text | unknown | `BATTLE_RAM.md`, `OVERLAY_HEADERS.md` |
| `0x80145FA8` | text | unknown | `BATTLE_RAM.md` |
| `0x80145FAC` | text | unknown | `BATTLE_RAM.md` |
| `0x80145FB0` | text | unknown | `BATTLE_RAM.md` |
| `0x80145FB4` | text | unknown | `BATTLE_RAM.md` |
| `0x80145FB6` | text | unknown | `BATTLE_RAM.md` |
| `0x80145FB8` | text | unknown | `BATTLE_RAM.md` |
| `0x80145FC0` | text | unknown | `BATTLE_RAM.md` |
| `0x80145FC4` | text | unknown | `BATTLE_RAM.md` |
| `0x80145FC8` | text | unknown | `BATTLE_RAM.md`, `STATUS.md` |
| `0x80145FCC` | text | unknown | `OVERLAY_HEADERS.md`, `STATUS.md` |
| `0x80146000` | text | unknown | `WORLD_ITEMS.md` |
| `0x801460E5` | text | unknown | `OVERLAY_HEADERS.md` |
| `0x8014624C` | text | unknown | `BATTLE_RAM.md`, `GHIDRA.md`, `STATUS.md` |
| `0x80146250` | text | unknown | `BATTLE_RAM.md`, `STATUS.md`, `remote-plan-2026-09-05.md` |
| `0x80146254` | text | unknown | `BATTLE_RAM.md` |
| `0x801462DC` | text | unknown | `BATTLE_RAM.md` |
| `0x801462DE` | text | unknown | `BATTLE_RAM.md` |
| `0x801462DF` | text | unknown | `BATTLE_RAM.md` |
| `0x801462E0` | text | unknown | `BATTLE_RAM.md` |
| `0x801462E4` | text | unknown | `BATTLE_RAM.md`, `STATUS.md` |
| `0x801462E6` | text | unknown | `BATTLE_RAM.md` |
| `0x801462EF` | text | unknown | `BATTLE_RAM.md` |
| `0x801462FF` | text | unknown | `BATTLE_RAM.md` |
| `0x80146300` | text | unknown | `BATTLE_RAM.md` |
| `0x80146308` | text | unknown | `BATTLE_RAM.md`, `STATUS.md`, `remote-plan-2026-09-05.md` |
| `0x8014631E` | text | unknown | `BATTLE_RAM.md`, `STATUS.md` |
| `0x8014631F` | text | unknown | `BATTLE_RAM.md` |
| `0x80146320` | text | unknown | `BATTLE_RAM.md`, `HANDOFF.md` |
| `0x80146322` | text | unknown | `BATTLE_RAM.md` |
| `0x80146323` | text | unknown | `BATTLE_RAM.md`, `STATUS.md` |
| `0x80146324` | text | unknown | `BATTLE_RAM.md` |
| `0x80146328` | text | unknown | `BATTLE_RAM.md` |
| `0x8014632C` | text | unknown | `BATTLE_RAM.md` |
| `0x80146330` | text | unknown | `BATTLE_RAM.md`, `STATUS.md` |
| `0x80146350` | text | unknown | `BATTLE_RAM.md`, `STATUS.md` |
| `0x80146360` | text | unknown | `BATTLE_RAM.md`, `HANDOFF.md` |
| `0x80146382` | text | unknown | `OVERLAY_HEADERS.md` |
| `0x80146390` | text | unknown | `BATTLE_RAM.md` |
| `0x8014639C` | text | unknown | `BATTLE_RAM.md`, `STATUS.md` |
| `0x801463AC` | text | unknown | `BATTLE_RAM.md` |
| `0x801463BC` | text | unknown | `OVERLAY_HEADERS.md` |
| `0x801463C4` | text | unknown | `BATTLE_RAM.md` |
| `0x801463CC` | text | unknown | `BATTLE_RAM.md` |
| `0x80146460` | text | unknown | `OVERLAY_HEADERS.md` |
| `0x80146464` | text | unknown | `HANDOFF.md`, `IDEAS.md`, `OVERLAY_HEADERS.md`, `STATUS.md` |
| `0x80146468` | text | unknown | `OVERLAY_HEADERS.md` |
| `0x80146490` | text | unknown | `OVERLAY_HEADERS.md`, `STATUS.md` |
| `0x8014649C` | text | unknown | `OVERLAY_HEADERS.md` |
| `0x80146800` | text | unknown | `regional-builds.md` |
| `0x80146860` | text | unknown | `BATTLE_RAM.md` |
| `0x8014686C` | text | unknown | `BATTLE_RAM.md`, `HANDOFF.md`, `STATUS.md` |
| `0x80146878` | text | unknown | `BATTLE_RAM.md` |
| `0x80146990` | text | unknown | `crash-kernel-ram-2934.md` |
| `0x8014832F` | text | unknown | `TEXT_ENGINE.md` |
| `0x801484B8` | text | unknown | `BATTLE_RAM.md`, `HANDOFF.md`, `STATUS.md` |
| `0x801484C3` | text | unknown | `BATTLE_RAM.md` |
| `0x801484CC` | text | unknown | `BATTLE_RAM.md`, `STATUS.md` |
| `0x801484D4` | text | unknown | `BATTLE_RAM.md` |
| `0x801484DC` | text | unknown | `BATTLE_RAM.md` |
| `0x80148500` | text | unknown | `BATTLE_RAM.md` |
| `0x8014850B` | text | unknown | `BATTLE_RAM.md` |
| `0x8014850C` | text | unknown | `BATTLE_RAM.md` |
| `0x8014852F` | text | unknown | `BATTLE_RAM.md` |
| `0x80148644` | text | unknown | `BATTLE_RAM.md`, `GHIDRA.md`, `HANDOFF.md`, `STATUS.md`, `TEXT_ENGINE.md` |
| `0x80148668` | text | unknown | `BATTLE_RAM.md` |
| `0x8014909C` | text | unknown | `TEXT_ENGINE.md` |
| `0x8014909D` | text | unknown | `TEXT_ENGINE.md` |
| `0x8014909E` | text | unknown | `TEXT_ENGINE.md` |
| `0x801490A0` | text | unknown | `IDEAS.md`, `INSERT_RUBY.md`, `STATUS.md`, `TEXT_ENGINE.md` |
| `0x801490A2` | text | unknown | `TEXT_ENGINE.md` |
| `0x801490A3` | text | unknown | `INSERT_RUBY.md`, `TEXT_ENGINE.md` |
| `0x801490A4` | text | unknown | `HANDOFF.md`, `IDEAS.md`, `LOCALIZATION_APPLY.md`, `STATUS.md`, `TEXT_ENGINE.md` |
| `0x801490A6` | text | unknown | `TEXT_ENGINE.md` |
| `0x801490A8` | text | unknown | `IDEAS.md`, `LOCALIZATION_APPLY.md`, `STATUS.md`, `TEXT_ENGINE.md` |
| `0x801490AC` | text | unknown | `IDEAS.md`, `INSERT_RUBY.md`, `LOCALIZATION_APPLY.md`, `STATUS.md`, `TEXT_ENGINE.md` |
| `0x801490B0` | text | unknown | `HANDOFF.md`, `INSERT_RUBY.md`, `STATUS.md`, `TEXT_ENGINE.md` |
| `0x801490B4` | text | unknown | `TEXT_ENGINE.md` |
| `0x801490B5` | text | unknown | `TEXT_ENGINE.md` |
| `0x801490B6` | text | unknown | `TEXT_ENGINE.md` |
| `0x801490B8` | text | unknown | `IDEAS.md`, `TEXT_ENGINE.md` |
| `0x801490BC` | text | unknown | `IDEAS.md`, `TEXT_ENGINE.md` |
| `0x801490C0` | text | unknown | `TEXT_ENGINE.md` |
| `0x801490C1` | text | unknown | `TEXT_ENGINE.md` |
| `0x801490C4` | text | unknown | `STATUS.md`, `TEXT_ENGINE.md` |
| `0x801490CA` | text | unknown | `TEXT_ENGINE.md` |
| `0x801490D3` | text | unknown | `INSERT_RUBY.md`, `STATUS.md`, `TEXT_ENGINE.md` |
| `0x801490D4` | text | unknown | `HANDOFF.md`, `INSERT_RUBY.md`, `README.md`, `STATUS.md`, `WORLD_ITEMS.md` |
| `0x801490DC` | text | unknown | `INSERT_RUBY.md` |
| `0x8014932E` | text | unknown | `BATTLE_RAM.md` |
| `0x8014933A` | text | unknown | `BATTLE_RAM.md` |
| `0x80149800` | text | unknown | `OVERLAYS.md`, `zero-fill-dispatch-audit.md` |
| `0x80149A5C` | text | unknown | `TEXT_ENGINE.md` |
| `0x80149AB4` | text | unknown | `TEXT_ENGINE.md` |
| `0x8014A0DC` | text | unknown | `BRINGUP.md` |
...
| `0x8014E9A0` | text | unknown | `OVERLAY_HEADERS.md` |
| `0x8014EB20` | text | unknown | `GHIDRA.md`, `OVERLAY_HEADERS.md`, `STATUS.md` |
...
| `0x801532A0` | text | unknown | `GHIDRA.md`, `STATUS.md` |
| `0x80155238` | text | unnamed function root (seeds/ghidra_funcs.txt) | `BATTLE_RAM.md` |
| `0x80159828` | text | unknown | `IDEAS.md` |
...
| `0x8015D508` | text | unknown | `GHIDRA.md` |
| `0x8015D5F0` | text | unknown | `GHIDRA.md` |
| `0x8015E908` | text | unnamed function root (seeds/ghidra_funcs.txt) | `AREA_PCS.md`, `GHIDRA.md`, `HANDOFF.md`, `STATUS.md`, `TEXT_ENGINE.md`, `WORLD_ITEMS.md` |
...
| `0x80164E84` | text | unknown | `HANDOFF.md`, `STATUS.md` |
...
| `0x80182488` | text | unknown | `BATTLE_RAM.md`, `HANDOFF.md`, `STATUS.md` |
| `0x80182DBC` | text | unknown | `HANDOFF.md`, `OVERLAY_HEADERS.md`, `STATUS.md` |
| `0x80184F78` | text | unknown | `OVERLAYS.md` |
| `0x80185FE8` | text | unknown | `OVERLAYS.md` |
| `0x8018603C` | text | unknown | `BRINGUP.md`, `HANDOFF.md`, `OVERLAY_EXTRACTION.md`, `STATUS.md`, `vblank-pacing-bug.md` |
| `0x80186400` | text | unknown | `LOCALIZATION.md` |
| `0x8018BBA8` | text | unknown | `BRINGUP.md` |
| `0x8018BBAC` | text | unknown | `BRINGUP.md` |
| `0x8018BBB0` | text | unknown | `BRINGUP.md` |
| `0x8018BBB4` | text | unknown | `BRINGUP.md` |
| `0x8018BC2C` | text | unknown | `BRINGUP.md`, `OVERLAYS.md` |
| `0x80190000` | text | unknown | `STATUS.md` |
| `0x80196800` | text | unknown | `AREA_PCS.md`, `BATTLE_RAM.md`, `GHIDRA.md`, `HANDOFF.md`, `INSERT_RUBY.md`, `OVERLAYS.md`, `OVERLAY_EXTRACTION.md`, `OVERLAY_SIZE.md`, `STATUS.md`, `regional-builds.md` |
| `0x80196801` | text | unknown | `OVERLAYS.md`, `zero-fill-dispatch-audit.md` |
| `0x80196F0C` | text | unknown | `INSERT_RUBY.md` |
| `0x80196FBC` | text | unknown | `INSERT_RUBY.md`, `WORLD_ITEMS.md` |
| `0x8019701C` | text | unnamed function root (seeds/ghidra_funcs.txt) | `zero-fill-dispatch-audit.md` |
| `0x801970B4` | text | unknown | `OVERLAYS.md`, `STATUS.md` |
| `0x80197718` | text | unknown | `BATTLE_RAM.md` |
| `0x8019CD40` | text | unnamed function root (seeds/ghidra_funcs.txt) | `zero-fill-dispatch-audit.md` |
| `0x801A1538` | text | unknown | `STATUS.md` |
| `0x801A1720` | text | unknown | `STATUS.md` |
| `0x801A19A8` | text | unknown | `STATUS.md` |
...
| `0x801A4F44` | text | unknown | `TEXT_ENGINE.md` |
| `0x801A5BC8` | text | unknown | `AREA_PCS.md` |
| `0x801A8C58` | text | unknown | `INSERT_RUBY.md` |
| `0x801AD93C` | text | unknown | `INSERT_RUBY.md` |
| `0x801AD9D0` | text | unknown | `INSERT_RUBY.md` |
| `0x801AEDD4` | text | Char_LevelUp [evidence] in Field/map core (large) (BIN/ETC/GAME.EMI#0) | `BATTLE_RAM.md`, `STATUS.md` |
| `0x801B1638` | text | unknown | `STATUS.md`, `crash-kernel-ram-2934.md` |
| `0x801B1C80` | text | unknown | `BATTLE_RAM.md` |
...
| `0x801B3870` | text | unknown | `INSERT_RUBY.md`, `STATUS.md` |
...
| `0x801B6444` | text | unknown | `BATTLE_RAM.md` |
...
| `0x801C3530` | text | unknown | `BATTLE_RAM.md` |
| `0x801C388C` | text | unknown | `BATTLE_RAM.md` |
| `0x801C3998` | text | unknown | `BATTLE_RAM.md` |
| `0x801C5C40` | text | unnamed function root (seeds/ghidra_funcs.txt) | `zero-fill-dispatch-audit.md` |
| `0x801C6790` | text | unknown | `BATTLE_RAM.md` |
| `0x801C67AC` | text | unknown | `BATTLE_RAM.md` |
| `0x801C9934` | text | unknown | `BATTLE_RAM.md`, `IDEAS.md`, `STATUS.md` |
| `0x801C9948` | text | unknown | `BATTLE_RAM.md`, `STATUS.md` |
| `0x801C995C` | text | unknown | `IDEAS.md`, `STATUS.md`, `TEXT_TABLES.md` |
| `0x801C9E64` | text | unknown | `TEXT_TABLES.md` |
| `0x801C9F24` | text | unknown | `TEXT_TABLES.md` |
| `0x801C9F2F` | text | unknown | `BATTLE_RAM.md` |
| `0x801CA5A0` | text | unknown | `TEXT_TABLES.md` |
| `0x801CAA68` | text | unknown | `TEXT_TABLES.md` |
| `0x801CB230` | text | unknown | `BATTLE_RAM.md`, `EMI_TYPES.md`, `IDEAS.md`, `STATUS.md`, `TEXT_TABLES.md` |
| `0x801CB231` | text | unknown | `BATTLE_RAM.md`, `IDEAS.md`, `TEXT_TABLES.md` |
| `0x801CC068` | text | unknown | `BATTLE_RAM.md`, `EMI_TYPES.md`, `GHIDRA.md`, `STATUS.md` |
| `0x801CE000` | text | unknown | `AREA_PCS.md`, `HANDOFF.md`, `IDEAS.md`, `STATUS.md`, `band-overlap-attribution.md`, `remote-plan-2026-09-05.md` |
| `0x801CE0E4` | text | unknown | `OVERLAYS.md` |
| `0x801CE400` | text | unknown | `AREA_PCS.md`, `HANDOFF.md`, `IDEAS.md`, `OVERLAYS.md`, `OVERLAY_EXTRACTION.md`, `OVERLAY_HEADERS.md`, `OVERLAY_SIZE.md`, `STATUS.md`, `band-overlap-attribution.md`, `zero-fill-dispatch-audit.md` |
| `0x801CE401` | text | unknown | `OVERLAYS.md`, `STATUS.md` |
| `0x801CE404` | text | unknown | `HANDOFF.md`, `STATUS.md` |
| `0x801CE724` | text | unknown | `STATUS.md` |
| `0x801CEEDC` | text | unknown | `HANDOFF.md`, `IDEAS.md`, `OVERLAYS.md`, `OVERLAY_EXTRACTION.md`, `STATUS.md` |
| `0x801CF980` | text | unknown | `STATUS.md` |
| `0x801D0AA8` | text | unknown | `STATUS.md` |
| `0x801D0ACC` | text | unknown | `OVERLAYS.md`, `OVERLAY_EXTRACTION.md` |
| `0x801D0C00` | text | unknown | `AREA_PCS.md`, `BATTLE_RAM.md`, `GHIDRA.md`, `HANDOFF.md`, `IDEAS.md`, `LOCALIZATION.md`, `NAME_MAP.md`, `OVERLAYS.md`, `OVERLAY_EXTRACTION.md`, `OVERLAY_HEADERS.md`, `OVERLAY_SIZE.md`, `STATUS.md`, `band-overlap-attribution.md`, `regional-builds.md` |
| `0x801D0C01` | text | unknown | `OVERLAYS.md`, `zero-fill-dispatch-audit.md` |
| `0x801D0C04` | text | unnamed function root (seeds/ghidra_funcs.txt) | `BATTLE_RAM.md`, `GHIDRA.md`, `STATUS.md`, `TEXT_TABLES.md`, `zero-fill-dispatch-audit.md` |
| `0x801D0C64` | text | unknown | `GHIDRA.md` |
| `0x801D0C68` | text | unknown | `GHIDRA.md` |
| `0x801D0C7C` | text | unknown | `BATTLE_RAM.md`, `STATUS.md` |
| `0x801D0CB8` | text | unknown | `BATTLE_RAM.md`, `remote-plan-2026-09-05.md` |
| `0x801D0D94` | text | unknown | `IDEAS.md`, `TEXT_TABLES.md` |
| `0x801D0E54` | text | unknown | `STATUS.md` |
...
| `0x801D0F80` | text | unknown | `GHIDRA.md`, `OVERLAY_HEADERS.md` |
| `0x801D0F9C` | text | unknown | `GHIDRA.md` |
| `0x801D1014` | text | unknown | `HANDOFF.md` |
| `0x801D10A8` | text | unknown | `BATTLE_RAM.md` |
...
| `0x801D3ED0` | text | unknown | `OVERLAY_HEADERS.md` |
| `0x801D51D8` | text | unknown | `BATTLE_RAM.md` |
...
| `0x801D9A84` | text | unknown | `GHIDRA.md` |
| `0x801D9C50` | text | unknown | `GHIDRA.md` |
| `0x801D9CA4` | text | unknown | `STATUS.md` |
| `0x801DA484` | text | unknown | `GHIDRA.md` |
| `0x801DA578` | text | unknown | `GHIDRA.md` |
...
| `0x801E3AE0` | text | unknown | `IDEAS.md` |
...
| `0x801E5230` | text | unknown | `IDEAS.md` |
| `0x801E524C` | text | unknown | `IDEAS.md` |
...
| `0x801EB74C` | text | unknown | `BATTLE_RAM.md`, `STATUS.md` |
| `0x801EB758` | text | unknown | `BATTLE_RAM.md` |
| `0x801EB8D0` | text | unknown | `remote-plan-2026-09-05.md` |
| `0x801EC258` | text | unknown | `BATTLE_RAM.md`, `STATUS.md` |
| `0x801EC25E` | text | unknown | `BATTLE_RAM.md` |
| `0x801EC273` | text | unknown | `BATTLE_RAM.md` |
| `0x801EC278` | text | unknown | `BATTLE_RAM.md`, `STATUS.md` |
| `0x801EC27C` | text | unknown | `BATTLE_RAM.md` |
| `0x801EC27E` | text | unknown | `BATTLE_RAM.md` |
| `0x801EC294` | text | unknown | `BATTLE_RAM.md` |
| `0x801EC3E8` | text | unknown | `BATTLE_RAM.md`, `STATUS.md` |
| `0x801ED5BC` | text | unknown | `BATTLE_RAM.md` |
| `0x801ED93F` | text | unknown | `GHIDRA.md` |
| `0x801EEC00` | text | unknown | `AREA_PCS.md`, `BATTLE_RAM.md`, `GHIDRA.md`, `HANDOFF.md`, `IDEAS.md`, `NAME_MAP.md`, `OVERLAYS.md`, `OVERLAY_EXTRACTION.md`, `OVERLAY_HEADERS.md`, `OVERLAY_SIZE.md`, `STATUS.md`, `gpu-polyline-terminator.md`, `zero-fill-dispatch-audit.md` |
| `0x801EEC01` | text | unknown | `OVERLAYS.md` |
| `0x801EEC10` | text | unknown | `DATA_ISLANDS.md`, `OVERLAY_HEADERS.md`, `README.md`, `STATUS.md` |
| `0x801EEC14` | text | unknown | `DATA_ISLANDS.md` |
...
| `0x801EEC9C` | text | unknown | `DATA_ISLANDS.md`, `STATUS.md` |
| `0x801EECA0` | text | unknown | `DATA_ISLANDS.md` |
| `0x801EECF4` | text | unknown | `gpu-polyline-terminator.md` |
...
| `0x801EF400` | text | ≤ BattleResult_Setup (overlay Battle result screen (BIN/BATTLE/BATL_END.EMI#0)) +0x70 (nearest below, span unknown) | `BATTLE_RAM.md` |
...
| `0x801F2C00` | text | unknown | `AREA_PCS.md`, `HANDOFF.md`, `IDEAS.md`, `NAME_MAP.md`, `OVERLAYS.md`, `OVERLAY_EXTRACTION.md`, `OVERLAY_HEADERS.md`, `OVERLAY_SIZE.md`, `README.md`, `STATUS.md`, `WORLD_ITEMS.md`, `regional-builds.md` |
| `0x801F2C01` | text | unknown | `OVERLAYS.md`, `zero-fill-dispatch-audit.md` |
| `0x801F2C04` | text | unnamed function root (seeds/ghidra_funcs.txt) | `GHIDRA.md`, `STATUS.md`, `zero-fill-dispatch-audit.md` |
| `0x801F2E6C` | text | unknown | `IDEAS.md`, `STATUS.md` |
| `0x801F3BBC` | text | unknown | `WORLD_ITEMS.md` |
| `0x801F3DFC` | text | unknown | `WORLD_ITEMS.md` |
| `0x801F4154` | text | unknown | `IDEAS.md` |
| `0x801F46D4` | text | unknown | `IDEAS.md` |
| `0x801F4814` | text | unknown | `IDEAS.md` |
| `0x801F4A30` | text | unknown | `WORLD_ITEMS.md` |
| `0x801F4CE4` | text | unknown | `WORLD_ITEMS.md` |
| `0x801F4D20` | text | unknown | `WORLD_ITEMS.md` |
| `0x801F6C00` | text | unknown | `AREA_PCS.md`, `HANDOFF.md`, `OVERLAYS.md`, `OVERLAY_EXTRACTION.md`, `OVERLAY_HEADERS.md`, `OVERLAY_SIZE.md`, `STATUS.md`, `zero-fill-dispatch-audit.md` |
| `0x801F6C90` | text | unknown | `HANDOFF.md`, `STATUS.md` |
| `0x801F6FFF` | text | unknown | `GHIDRA.md` |
| `0x801F7000` | post-text | end of the boot EXE .text span (load + text_size) | `BRINGUP.md`, `regional-builds.md` |
